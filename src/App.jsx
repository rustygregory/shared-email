            ...
            <ModeFieldWrapper>
              <Field>
                <Combobox
                  isCompact
                  isEditable={false}
                  inputValue={mode === 'mvp' ? 'MVP' : mode === 'mvp2' ? 'MVP v2' : mode === 'scaled' ? 'Scaled' : mode === 'workspace2' ? 'Workspace V2' : mode === 'workspace3' ? 'Workspace V3' : 'Workspace'}
                  selectionValue={mode}
                ...
                >
                  ...
                  <Option value="workspace3">Workspace V3</Option>
                </Combobox>
              </Field>
            </ModeFieldWrapper>
          </ToggleOverlay>
